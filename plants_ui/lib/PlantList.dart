...
import 'package:plants_ui/Plantdetail.dart';
...
class _PlantListState extends State<PlantList> {
  ...
  List allDescriptions = [
    ...
    'Peace lilies are sturdy, easy to grow plants with glossy, dark green oval leaves that narrow to a point'
  ];
      ...
      children: <Widget>[
        Container(
          ...
          child: ListView(
            ...
            children: <Widget>[
              getPlantCard(
                  'assets/whiteplant.png', '30', 'OUTDOOR', 'Aloe Vera'),
              SizedBox(width: 15.0),
              getPlantCard('assets/smallplant.png', '25', 'INDOOR', 'Ficus'),
              SizedBox(width: 15.0),
              getPlantCard('assets/lily.png', '35', 'INDOOR', 'Lily'),
              SizedBox(width: 15.0),
            ],
          ),
        ),
        ...
        InkWell(
          onTap: () {
            Navigator.of(context).push(MaterialPageRoute(
                builder: (context) => PlantDetail(imgPath,price,plantType,plantName)
            ));
          },
          child: Container(
            height: 325.0,
